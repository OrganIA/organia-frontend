    ...
    <form @submit.prevent="submitForm()" class="show-requireds">
      ...
      <div class="form-fields">
        ...
        <div class="form-input small">
          ...
          <input v-model="receiver.start_date" placeholder="start date" type="date" />
        </div>
        <div class="form-input small">
          <label class="label">Date de fin</label>
          <input v-model="receiver.end_date" placeholder="end date" type="date" class="input is-info" />
        </div>
        <div class="form-input small">
          <label class="label">Nombre de tumeurs</label>
          <input v-model="receiver.tumors_number" placeholder="0" type="text" class="input is-info" />
        </div>
        <div class="form-input small required">
        ...
        <div class="form-input small">
          ...
          <input v-model="receiver.startDateDialyse" placeholder="start date" type="date" class="input is-info" />
        </div>
        <div class="form-input small">
          <label class="label">Date de fin de dialyse</label>
          <input v-model="receiver.endDateDialyse" placeholder="start date" type="date" class="input is-info" />
        </div>
        <div class="form-input small required">
          <label class="label">A-t-il effectué une retransplantation ?</label>
          <select v-model="receiver.isRetransplantation" name="retransplantation" id="transplantation-select"
